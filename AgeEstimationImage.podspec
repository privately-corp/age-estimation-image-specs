Pod::Spec.new do |s|
    ...
    s.license = { :type => 'Copyright', :text => <<-LICENSE
                   Copyright 2024 Privately SA
                  LICENSE
                }
    s.author             = { "Mathieu Monney" => "developer.contact@privately.eu" }
    s.source       = { :http => 'https://sos-ch-dk-2.exo.io/eu.privately.sdk/ios/age-estimation/AgeEstimationImage-1.0.4.xcframework.zip' }
    s.vendored_frameworks = ["AgeEstimationImage.xcframework"]
    s.dependency 'PrivatelyCoreIos', '1.0.1'
